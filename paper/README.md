...
release-candidate evidence. Claims remain limited to seed 42 on the official
PlantVillage split unless explicitly stated. The known 227 overlapping leaf IDs,
controlled backgrounds, incomplete human review, and absent field validation remain
binding limitations. Panjoel is the sole author; Codex is disclosed only as a tool.
